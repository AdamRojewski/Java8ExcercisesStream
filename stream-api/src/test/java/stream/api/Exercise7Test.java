...
public class Exercise7Test extends ClassicOnlineStore {
    ...
    public void averageAge() {
         ...
         */
        IntStream ageStream = customerList.stream().mapToInt(Customer::getAge); // average().getAsDouble nie dziala....
    ...
    public void howMuchToBuyAllItems() {
         ...
         */
        LongStream priceStream = shopList.stream().flatMap(shop -> shop.getItemList().stream()).mapToLong(Item::getPrice); // ronica miedzy flatMap a map????
